...
def main():
    ...
    for i in range (1,11):
        ...
        #archivo inicial
        archivo = "C://Users//Luis Da//Documents//9o Semestre//Inteligencia computacional//Evaluacion1//examen.csv"
        #Archivo con los datos de testing -- se va a crear
        testing = "C://Users//Luis Da//Documents//9o Semestre//Inteligencia computacional//Evaluacion1//examenTesting"+str(i)+".csv"
        #archivo con los datos reales -- se va a crear
        reales = "C://Users//Luis Da//Documents//9o Semestre//Inteligencia computacional//Evaluacion1//examenReales"+str(i)+".csv"
